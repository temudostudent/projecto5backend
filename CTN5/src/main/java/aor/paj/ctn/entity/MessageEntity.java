...
@NamedQuery(name = "Message.findMessagesBetweenTwoUsers", query = "SELECT m FROM MessageEntity m WHERE (m.sender = :user1 AND m.recipient = :user2) OR (m.sender = :user2 AND m.recipient = :user1)")
