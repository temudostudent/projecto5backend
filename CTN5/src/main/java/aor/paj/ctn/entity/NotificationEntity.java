...
@NamedQuery(name = "Notification.findNotificationsBySenderAndReceiverAndType", query = "SELECT n FROM NotificationEntity n WHERE n.sender.username = :senderUsername AND n.recipient.username = :receiverUsername AND n.type = :type AND n.readStatus = :readStatus ORDER BY n.timestamp DESC")
